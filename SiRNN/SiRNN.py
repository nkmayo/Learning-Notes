...
just a regular RNN. Weight initialization can't be a sinusoid?
Sources: 
...
class SiRNNet(nn.Module):
    def __init__(self, input_features, recurrent_size, intermediate_size, output_features, 
                 outermost_linear=True, first_omega_0=30, intermediate_omega_0=30., activation='sin'):
        super().__init__()
        self.recurrent_size = recurrent_size
        self.SiRNN = SiRNN(input_features, recurrent_size, intermediate_size,
                                  is_first=True, omega_0=first_omega_0, activation=activation)
...
n_hidden=64
rnn = SiRNNet(n_letters, n_hidden, n_categories, n_categories, activation='tanh')
